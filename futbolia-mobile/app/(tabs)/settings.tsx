    ...
    >
      <View style={styles.settingRow}>
        ...
        <View style={styles.settingInfo}>
          ...
          {subtitle && (
            <ThemedText variant="muted" size="sm">{subtitle}</ThemedText>
          )}
        </View>
        {right}
      </View>
          ...
          <Card variant="default" padding="none">
            <TouchableOpacity
              ...
              style={[
                ...
                currentLang === 'es' && { backgroundColor: theme.colors.primary + '15' },
              ]}
            >
              ...
              {currentLang === 'es' && (
                <ThemedText variant="primary" style={styles.checkmark}>✓</ThemedText>
              )}
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              style={[
                styles.languageOption,
                currentLang === 'en' && { backgroundColor: theme.colors.primary + '15' },
              ]}
            >
              <ThemedText size="xl">🇺🇸</ThemedText>
        ...
        <Card variant="outlined" padding="md" style={styles.techCard}>
          ...
          <View style={styles.techGrid}>
            <View style={styles.techItem}>
              ...
              <ThemedText variant="muted" size="xs">React Native</ThemedText>
            </View>
            <View style={styles.techItem}>
              <ThemedText size="lg">📱</ThemedText>
              <ThemedText variant="muted" size="xs">Expo</ThemedText>
            </View>
            <View style={styles.techItem}>
              <ThemedText size="lg">⚡</ThemedText>
              <ThemedText variant="muted" size="xs">FastAPI</ThemedText>
            </View>
            <View style={styles.techItem}>
              <ThemedText size="lg">🧠</ThemedText>
              <ThemedText variant="muted" size="xs">DeepSeek</ThemedText>
            </View>
            <View style={styles.techItem}>
              <ThemedText size="lg">🗄️</ThemedText>
              <ThemedText variant="muted" size="xs">MongoDB</ThemedText>
            </View>
            <View style={styles.techItem}>
              <ThemedText size="lg">🔍</ThemedText>
              <ThemedText variant="muted" size="xs">ChromaDB</ThemedText>
            </View>
          </View>
        </Card>

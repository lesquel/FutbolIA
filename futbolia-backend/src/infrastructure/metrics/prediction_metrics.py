...
class MetricsReport:
    ...
    roi: Optional[float] = None  # Return on Investment para apuestas
    ...
    def to_dict(self) -> Dict:
        return {
            ...
            "precision_by_class": {k: round(v * 100, 2) for k, v in self.precision_by_class.items()},
...
class PredictionMetrics:
    ...
    def calculate_roi(
        ...
        roi_by_class = {cls: {"staked": 0, "returned": 0} for cls in PredictionMetrics.RESULT_CLASSES}
    ...
    @staticmethod
    def compare_models(
        model_results: Dict[str, Tuple[List[Dict], List[str]]]
    ) -> Dict[str, Any]:
        """

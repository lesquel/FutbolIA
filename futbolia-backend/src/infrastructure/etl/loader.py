...
from src.infrastructure.etl.transformer import TransformationResult
...
class DataLoader:
    ...
    async def load_standings(
        self, league_code: str, season: str, result: TransformationResult, to_mongodb: bool = True
    ) -> dict[str, Any]:
        """
    ...
    async def load_ml_features(
        self, league_code: str, features: list[dict], feature_type: str = "prediction"
    ) -> dict[str, Any]:
        """
        ...
        try:
            ...
            return {"success": True, "filepath": str(filepath), "features_saved": len(features)}
    ...
    async def load_league_data(
        ...
        league_code: str,
        season: str,
        standings_result: TransformationResult | None = None,
        matches_result: TransformationResult | None = None,
        teams_result: TransformationResult | None = None,
    ) -> dict[str, Any]:
        """
        ...
        if matches_result:
            batch_result["matches"] = await self.load_matches(league_code, season, matches_result)
    ...
    def get_load_stats(self) -> dict[str, Any]:
        ...
        return {
            **self._load_stats,
            ...
            "leagues_available": [d.name for d in self.leagues_dir.iterdir() if d.is_dir()]
